...
impl DividendStream {
    pub fn new(dividends: &[Dividend], div_yield: RcRateCurve) -> DividendStream {
        ...
        let mut last_cash_ex_date = Date::default();
...
mod tests {
    ...
    fn check_undiscounted_divs() {
        ...
        let divs = create_sample_divstream();
        let b = create_sample_bootstrap(&divs, d + Days::new(1000));

        assert_cash(b.undiscounted_sum_from_base(d), 0.0);
        assert_cash(b.undiscounted_sum_from_base(d + Days::new(27)), 0.0);
        assert_cash(b.undiscounted_sum_from_base(d + Days::new(28)), 1.2);
        assert_cash(b.undiscounted_sum_from_base(d + Days::new(209)), 1.2);
        assert_cash(
            b.undiscounted_sum_from_base(d + Days::new(210)),
            2.20038399593182,
        );
        assert_cash(
            b.undiscounted_sum_from_base(d + Days::new(391)),
            2.20038399593182,
        );
        assert_cash(
            b.undiscounted_sum_from_base(d + Days::new(392)),
            3.220738125862416,
        );
        assert_cash(
            b.undiscounted_sum_from_base(d + Days::new(573)),
            3.220738125862416,
        );
        assert_cash(
            b.undiscounted_sum_from_base(d + Days::new(574)),
            4.2711648601357854,
        );
        assert_cash(
            b.undiscounted_sum_from_base(d + Days::new(800)),
            4.2711648601357854,
        );

        assert_cash(
            b.undiscounted_sum(d + Days::new(28), d + Days::new(210)),
            1.00038399593182,
        );
    }
    ...
    fn check_discounted_divs() {
        ...
        assert_cash(b.discounted_sum_from_base(d + Days::new(27)), 0.0);
        assert_cash(
            b.discounted_sum_from_base(d + Days::new(28)),
            1.192633077939713,
        );
        assert_cash(
            b.discounted_sum_from_base(d + Days::new(209)),
            1.192633077939713,
        );
        assert_cash(
            b.discounted_sum_from_base(d + Days::new(210)),
            2.1488682464776474,
        );
        assert_cash(
            b.discounted_sum_from_base(d + Days::new(391)),
            2.1488682464776474,
        );
        assert_cash(
            b.discounted_sum_from_base(d + Days::new(392)),
            3.0923131208475008,
        );
        assert_cash(
            b.discounted_sum_from_base(d + Days::new(573)),
            3.0923131208475008,
        );
        assert_cash(
            b.discounted_sum_from_base(d + Days::new(574)),
            4.031044985042786,
        );
        assert_cash(
            b.discounted_sum_from_base(d + Days::new(800)),
            4.031044985042786,
        );

        assert_cash(
            b.discounted_sum(d + Days::new(28), d + Days::new(210)),
            0.9562351685379344,
        );
    }
    ...
    fn create_sample_bootstrap(div_stream: &DividendStream, hwm: Date) -> DividendBootstrap {
        ...
        let borrow_points = [
            ...
            (d + Days::new(728), 0.0120),
        ];
        let borrow = RateCurveAct365::new(d, &borrow_points, Extrap::Flat, Extrap::Flat).unwrap();
        let spot = 97.0;

        DividendBootstrap::new(div_stream, &rate, &borrow, spot, d + Days::new(2), hwm).unwrap()
    }
