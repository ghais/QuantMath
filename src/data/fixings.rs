...
mod tests {
            ...
            &[
                (
                    ...
                    &[
                        ...
                        (DateTime::new(today - Days::new(7), TimeOfDay::Close), 123.3),
                        (DateTime::new(today - Days::new(7), TimeOfDay::Open), 123.2),
                        (DateTime::new(today - Days::new(9), TimeOfDay::Open), 123.1),
                    ],
                ),
                (
                    &"GSK.L",
                    &[
                        ...
                        (DateTime::new(today - Days::new(7), TimeOfDay::Close), 223.3),
                        (DateTime::new(today - Days::new(7), TimeOfDay::Open), 223.2),
                    ],
                ),
            ],
        )
    ...
    fn missing_fixing_past() {
        ...
        let _ = fixings
            .get(
                "BT.L",
                DateTime::new(today - Days::new(9), TimeOfDay::Close),
            )
            .unwrap();
    }
    ...
    fn find_fixing_past() {
        ...
        let today = fixings.fixings_known_until();
        let fixing = fixings
            .get("BT.L", DateTime::new(today - Days::new(7), TimeOfDay::Open))
            .unwrap();
        if let Some(f) = fixing {
            assert_eq!(f, 123.2);
        } else {
    ...
    fn missing_optional_fixing_past() {
        let fixings = sample_fixings();
        let today = fixings.fixings_known_until();
        let fixing = fixings.get_optional(
            "BT.L",
            DateTime::new(today - Days::new(9), TimeOfDay::Close),
        );
        if let Some(_) = fixing {
    ...
    fn find_optional_fixing_past() {
        ...
        let today = fixings.fixings_known_until();
        let fixing =
            fixings.get_optional("BT.L", DateTime::new(today - Days::new(9), TimeOfDay::Open));
        if let Some(f) = fixing {
            assert_eq!(f, 123.1);
        } else {
