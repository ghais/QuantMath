...
mod tests {
    ...
    fn driftless_forward() {
        ...
        assert_match(fwd.forward(d + Days::new(100)), 123.4);
    }
    ...
    fn interpolated_forward() {
        ...
        assert_match(fwd.forward(d + Days::new(30)), 103.0);
        assert_match(fwd.forward(d + Days::new(60)), 97.0);
        assert_match(fwd.forward(d + Days::new(90)), 99.0);
        assert_match(fwd.forward(d + Days::new(120)), 105.0);
    }
    ...
    fn equity_forward() {
        ...
        assert_match(fwd.forward(d + Days::new(27)), 97.55511831033844);
        assert_match(fwd.forward(d + Days::new(28)), 96.35511831033844);
        assert_match(fwd.forward(d + Days::new(60)), 97.02249458204768);
        assert_match(fwd.forward(d + Days::new(90)), 97.61947501213612);
        assert_match(fwd.forward(d + Days::new(120)), 98.242454295387);
        assert_match(fwd.forward(d + Days::new(150)), 98.96059291192566);
        assert_match(fwd.forward(d + Days::new(180)), 99.64145192620384);
        assert_match(fwd.forward(d + Days::new(209)), 100.18493401723067);
        assert_match(fwd.forward(d + Days::new(210)), 99.18464159368386);
        assert_match(fwd.forward(d + Days::new(240)), 99.75346887674715);
        assert_match(fwd.forward(d + Days::new(270)), 100.34720455926485);
        assert_match(fwd.forward(d + Days::new(300)), 100.87344226359396);
        assert_match(fwd.forward(d + Days::new(600)), 104.51748569914179);
        assert_match(fwd.forward(d + Days::new(900)), 110.7100396163593);
        assert_match(fwd.forward(d + Days::new(1200)), 117.8483691785027);
        assert_match(fwd.forward(d + Days::new(1500)), 125.93011849243018);
    }
    ...
    fn create_sample_divstream() -> DividendStream {
        ...
        let d = Date::from_ymd(2017, 01, 02);
        let divs = [
            Dividend::new(1.2, 0.0, d + Days::new(28), d + Days::new(30)),
            Dividend::new(0.8, 0.002, d + Days::new(210), d + Days::new(212)),
            Dividend::new(0.2, 0.008, d + Days::new(392), d + Days::new(394)),
            Dividend::new(0.0, 0.01, d + Days::new(574), d + Days::new(576)),
        ];

        // dividend yield for later-dated divs. Note that the base date
        // for the curve is after the last of the explicit dividends.
        let points = [
            (d + Days::new(365 * 2), 0.002),
            (d + Days::new(365 * 3), 0.004),
            (d + Days::new(365 * 5), 0.01),
            (d + Days::new(365 * 10), 0.015),
        ];
        let curve =
            RateCurveAct365::new(d + Days::new(365 * 2), &points, Extrap::Zero, Extrap::Flat)
                .unwrap();
    ...
    fn create_sample_rate() -> RcRateCurve {
        ...
        let rate_points = [
            ...
            (d + Days::new(14), 0.08),
            (d + Days::new(182), 0.09),
            (d + Days::new(364), 0.085),
            (d + Days::new(728), 0.082),
        ];
    ...
    fn create_sample_borrow() -> RcRateCurve {
        ...
        let borrow_points = [
            (d, 0.01),
            (d + Days::new(196), 0.012),
            (d + Days::new(364), 0.0125),
            (d + Days::new(728), 0.012),
        ];
        RcRateCurve::new(Arc::new(
