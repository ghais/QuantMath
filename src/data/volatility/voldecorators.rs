...
mod tests {
    ...
    fn constant_expiry_vol_surface() {
        ...
        let expiry = DateDayFraction::new(base_date.date() + Days::new(14), 0.7);
        unbumped
    ...
    fn constant_expiry_dynamics() {
        ...
        dynamics
            .modify(&mut bumped, base_date.date() + Days::new(4))
            .unwrap();
    ...
    fn rolling_expiry_vol_surface() {
        ...
        let expiry = DateDayFraction::new(base_date.date() + Days::new(10), 0.7);
        rolled
    ...
    fn rolling_expiry_dynamics() {
        ...
        let mut bumped = unbumped.clone();
        dynamics
            .modify(&mut bumped, base_date.date() + Days::new(7))
            .unwrap();

        // Manually roll the vol surface by creating a sample with a different
        // base date. Five business days after Friday 25 is Friday 1
        let rolled_base_date = DateDayFraction::new(base_date.date() + Days::new(7), 0.0);
        let rolled = sample_vol_surface(rolled_base_date);
    ...
    fn sticky_delta_bumped_vol_surface() {
        ...
        let points = [
            ...
            (d + Days::new(90), 99.11),
            (d + Days::new(120), 99.0),
            (d + Days::new(240), 98.89),
            (d + Days::new(480), 98.78),
            (d + Days::new(960), 98.78),
        ];
        ...
        let expiry = DateDayFraction::new(d + Days::new(14), 0.7);
        unbumped
