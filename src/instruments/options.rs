...
impl Priceable for SpotStartingEuropean {
    ...
    fn prices(
        ...
        let before_time = DateDayFraction::new(Date::default(), 0.0);
        self.vanilla
...
mod tests {
    ...
    impl PricingContext for SamplePricingContext {
        ...
        fn forward_curve(
            ...
            let points = [
                (d, self.spot),
                (d + Days::new(30), 1.03 * self.spot),
                (d + Days::new(60), 0.97 * self.spot),
                (d + Days::new(90), 0.99 * self.spot),
                (d + Days::new(120), 1.05 * self.spot),
            ];
